...
import topDriverLogo from "../assests/topDriverLogo.png";
...
const TopDrivers = () => {
  ...
  const bulletPoints = [
    ...
    "You can ask the bot about Top Drivers’s driver education programs, class schedules, pricing, and available training locations.",
  ...
  return (
    <div style={containerStyle}>
      <div style={logoBackground}>
        ...
        <img src={topDriverLogo} alt="Akasa Logo" height={isMobile ? 40 : 40} />
      </div>
      ...
      >
        <div style={mainWrapperStyle}>
          ...
          <p style={subtitleStyle}>
            We are happy to help you with your Top-Drivers queries ..
          </p>
      ...
      <div ref={widgetRef}>
        <elevenlabs-convai agent-id="agent_6001k7h2rxfeeg58ah8w98xjgcbw" />
      </div>
    </div>
  );
};
